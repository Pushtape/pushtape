...
function pushtape_install_tasks(&$install_state) {
  ...
  $tasks = $tasks + apps_profile_install_tasks($install_state, array('machine name' => 'panopoly', 'default apps' => array('panopoly_wysiwyg', 'pushtape_discography', 'pushtape_mediaplayer'))
