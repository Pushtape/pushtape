...
//  $tasks = $tasks + apps_profile_install_tasks($install_state, array('machine name' => //'pushtape', 'default apps' => array('pushtape_discography', 'pushtape_core'))
//
//);
...
function pushtape_form_panopoly_theme_selection_form_alter(&$form, &$form_state, $form_id) {
  $form['theme_wrapper']['theme']['#default_value'] = 'pushtape_omega';
}
