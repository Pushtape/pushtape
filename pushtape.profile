...
function pushtape_install_tasks(&$install_state) {
  ...
  require_once(drupal_get_path('module', 'pushtape_theme') . '/pushtape_theme.profile.inc');

  // Assemble and return the install tasks
  $tasks = array();
  //  Panopoly apps
  $tasks = $tasks + apps_profile_install_tasks($install_state, array('machine name' => 'panopoly', 'default apps' => array('pushtape_discography')));
  //  Pushtape apps
  $tasks = $tasks + apps_profile_install_tasks($install_state, array('machine name' => 'pushtape', 'default apps' => array('pushtape_demo')));
